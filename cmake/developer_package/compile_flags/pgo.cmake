...
#             with metadata (frame pointers, debug info) for accurate
#             hardware profile collection.
#   USE:      compile with -fprofile-sample-use=<file> to optimize using
#             the collected hardware profile.
# ============================================================================
...
if(NOT ENABLE_HWPGO STREQUAL "OFF")
    ...
    if(ENABLE_HWPGO STREQUAL "GENERATE")
        ...
        # -fprofile-sample-generate adds frame pointers and debug metadata
        # so that hardware profiling tools (VTune, perf) can collect
        # accurate sample-based profiles.
        ...
        message(STATUS "  1. Build the project with this configuration")
        message(STATUS "  2. Run representative workloads under hardware profiling:")
        message(STATUS "       Windows: Use Intel VTune to collect sampling data")
        message(STATUS "       Linux:   perf record -b -o perf.data -- ./your_workload")
        message(STATUS "  3. Convert to compiler-consumable profile:")
        message(STATUS "       llvm-profgen --binary=<binary> --perfdata=perf.data --output=profile.afdo")
        message(STATUS "       (or use VTune's export functionality)")
        message(STATUS "  4. Reconfigure with:")
        message(STATUS "       -DENABLE_HWPGO=USE -DHWPGO_PROFILE_FILE=<path/to/profile.afdo>")
    ...
    elseif(ENABLE_HWPGO STREQUAL "USE")
        ...
        if(NOT HWPGO_PROFILE_FILE)
            message(FATAL_ERROR
                ...
                "  Set it to the path of the .afdo profile collected during the GENERATE phase.")
        endif()
        ...
        # -fprofile-sample-use works on both Windows and Linux ICX
