...
macro(ov_sse42_optimization_flags flags)
    ...
    elseif(OV_COMPILER_IS_INTEL_LLVM)
        if(WIN32)
            if(NOT OV_TARGET_ARCH STREQUAL "OFF" AND DEFINED OV_TARGET_ARCH)
                set(${flags} /Qx${OV_TARGET_ARCH})
            else()
                set(${flags} /QxSSE4.2)
            endif()
        else()
            if(NOT OV_TARGET_ARCH STREQUAL "OFF" AND DEFINED OV_TARGET_ARCH)
                string(TOLOWER "${OV_TARGET_ARCH}" _ov_arch_lower)
                set(${flags} -x${_ov_arch_lower})
            else()
                set(${flags} -xSSE4.2)
            endif()
        endif()
